"""Experiment 029: localize the 7x2 residual from Exp028."""
...
SEEDS=[11,22,33]; ARCH=[(7,2),(14,4),(49,2)]; K=[1,2,3,4]
class FB(nn.Module):
...
rows=[]; prog=ResearchProgress("Exp029",9)
for seed in SEEDS:
 for g,w in ARCH:
