...
Path("pnn-v1/results").mkdir(parents=True,exist_ok=True); Path("pnn-v1/results/result012.json").write_text(json.dumps(payload,indent=2)+"\n"); print(json.dumps({"summary":summary,"mlp_calibration":mlp_summary,"success":success,"transfer_decision":payload["transfer_decision"]},indent=2))
